...
namespace Smithers.Worker.AzureDataAccess {
    ...
    public partial class ExportInput : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        private Smithers.Worker.AzureDataAccess.BlobCredentials BlobCredentialsField;
        
        private Smithers.Worker.AzureDataAccess.ConnectionInfo ConnectionInfoField;
        ...
        public Smithers.Worker.AzureDataAccess.BlobCredentials BlobCredentials {
            get {
        ...
        [System.Runtime.Serialization.DataMemberAttribute(IsRequired=true, EmitDefaultValue=false)]
        public Smithers.Worker.AzureDataAccess.ConnectionInfo ConnectionInfo {
            get {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="BlobCredentials", Namespace="http://schemas.datacontract.org/2004/07/Microsoft.SqlServer.Management.Dac.Servic" +
        "eTypes")]
    [System.SerializableAttribute()]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(Smithers.Worker.AzureDataAccess.BlobSharedAccessKeyCredentials))]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(Smithers.Worker.AzureDataAccess.BlobStorageAccessKeyCredentials))]
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="BlobSharedAccessKeyCredentials", Namespace="http://schemas.datacontract.org/2004/07/Microsoft.SqlServer.Management.Dac.Servic" +
        "eTypes")]
    [System.SerializableAttribute()]
    public partial class BlobSharedAccessKeyCredentials : Smithers.Worker.AzureDataAccess.BlobCredentials {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="BlobStorageAccessKeyCredentials", Namespace="http://schemas.datacontract.org/2004/07/Microsoft.SqlServer.Management.Dac.Servic" +
        "eTypes")]
    [System.SerializableAttribute()]
    public partial class BlobStorageAccessKeyCredentials : Smithers.Worker.AzureDataAccess.BlobCredentials {
    ...
    public partial class SelectiveExportInput : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private Smithers.Worker.AzureDataAccess.TableName[] TablesField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public Smithers.Worker.AzureDataAccess.TableName[] Tables {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="AzureDataAccess.IDACWebService")]
    public interface IDACWebService {
        ...
        System.Guid Export(Smithers.Worker.AzureDataAccess.ExportInput exportInput);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDACWebService/Export", ReplyAction="http://tempuri.org/IDACWebService/ExportResponse")]
        System.Threading.Tasks.Task<System.Guid> ExportAsync(Smithers.Worker.AzureDataAccess.ExportInput exportInput);
        ...
        System.Guid SelectiveExport(Smithers.Worker.AzureDataAccess.SelectiveExportInput exportInput);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDACWebService/SelectiveExport", ReplyAction="http://tempuri.org/IDACWebService/SelectiveExportResponse")]
        System.Threading.Tasks.Task<System.Guid> SelectiveExportAsync(Smithers.Worker.AzureDataAccess.SelectiveExportInput exportInput);
        ...
        System.Guid Import(Smithers.Worker.AzureDataAccess.ImportInput importInput);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDACWebService/Import", ReplyAction="http://tempuri.org/IDACWebService/ImportResponse")]
        System.Threading.Tasks.Task<System.Guid> ImportAsync(Smithers.Worker.AzureDataAccess.ImportInput importInput);
        ...
        Smithers.Worker.AzureDataAccess.StatusInfo[] PostStatus(Smithers.Worker.AzureDataAccess.StatusInput statusInput);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDACWebService/PostStatus", ReplyAction="http://tempuri.org/IDACWebService/PostStatusResponse")]
        System.Threading.Tasks.Task<Smithers.Worker.AzureDataAccess.StatusInfo[]> PostStatusAsync(Smithers.Worker.AzureDataAccess.StatusInput statusInput);
        ...
        Smithers.Worker.AzureDataAccess.StatusInfo[] GetStatus(string serverName, string userName, string password, string requestId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDACWebService/GetStatus", ReplyAction="http://tempuri.org/IDACWebService/GetStatusResponse")]
        System.Threading.Tasks.Task<Smithers.Worker.AzureDataAccess.StatusInfo[]> GetStatusAsync(string serverName, string userName, string password, string requestId);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IDACWebServiceChannel : Smithers.Worker.AzureDataAccess.IDACWebService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class DACWebServiceClient : System.ServiceModel.ClientBase<Smithers.Worker.AzureDataAccess.IDACWebService>, Smithers.Worker.AzureDataAccess.IDACWebService {
        ...
        public System.Guid Export(Smithers.Worker.AzureDataAccess.ExportInput exportInput) {
            return base.Channel.Export(exportInput);
        }
        
        public System.Threading.Tasks.Task<System.Guid> ExportAsync(Smithers.Worker.AzureDataAccess.ExportInput exportInput) {
            return base.Channel.ExportAsync(exportInput);
        }
        
        public System.Guid SelectiveExport(Smithers.Worker.AzureDataAccess.SelectiveExportInput exportInput) {
            return base.Channel.SelectiveExport(exportInput);
        }
        
        public System.Threading.Tasks.Task<System.Guid> SelectiveExportAsync(Smithers.Worker.AzureDataAccess.SelectiveExportInput exportInput) {
            return base.Channel.SelectiveExportAsync(exportInput);
        }
        
        public System.Guid Import(Smithers.Worker.AzureDataAccess.ImportInput importInput) {
            return base.Channel.Import(importInput);
        }
        
        public System.Threading.Tasks.Task<System.Guid> ImportAsync(Smithers.Worker.AzureDataAccess.ImportInput importInput) {
            return base.Channel.ImportAsync(importInput);
        }
        
        public Smithers.Worker.AzureDataAccess.StatusInfo[] PostStatus(Smithers.Worker.AzureDataAccess.StatusInput statusInput) {
            return base.Channel.PostStatus(statusInput);
        }
        
        public System.Threading.Tasks.Task<Smithers.Worker.AzureDataAccess.StatusInfo[]> PostStatusAsync(Smithers.Worker.AzureDataAccess.StatusInput statusInput) {
            return base.Channel.PostStatusAsync(statusInput);
        }
        
        public Smithers.Worker.AzureDataAccess.StatusInfo[] GetStatus(string serverName, string userName, string password, string requestId) {
            return base.Channel.GetStatus(serverName, userName, password, requestId);
        }
        
        public System.Threading.Tasks.Task<Smithers.Worker.AzureDataAccess.StatusInfo[]> GetStatusAsync(string serverName, string userName, string password, string requestId) {
